                        ...
                        foreach ($cases_requests as $row) :
                            ...
                            <div class="product-card" style="color: #fff; font-size: 15px;">
                                <div class="infras_card">
                                    <img class="case_image"
                                         src="../../mobile/api/v1/Requests/mobile_uploads/<?= $infras->getImagepath() ?>"/>
                                    <h1 style="color: #228765; font-size: 22px;"><?= $infras->getTitle() ?></h1>
                                    <p style="color: #0f3c2d;"><?= $infras->getDescription() ?></p>
                                    <p style="color:#36CC7C "><span
                                                style="color: #0f3c2d;">User</span> <?= $infras->getUser()->getFullname() ?>
                                    </p>
                                    <p style="color:#36CC7C ">
                                        <span style="color: #0f3c2d;">Date</span> <?= $infras->getDateCreated() ?>
                                    </p>
                                    ...
                                    <div class="myactionbtn" style="margin-top: 1em; display: flex;grid-gap: 1em;">
                                        ...
                                        <div class="approvebutton_parent">
                                            <input class="cardID" type="hidden" name="ID"
                                                   value="<?= $infras->getId() ?>">
                                            <button class="approvebutton">Confirm</button>
                                        </div>

                                        <div class="cancebutton_parent">
                                            <input class="cardID" type="hidden" name="orderID"
                                                   value="<?= $infras->getId() ?>">
            ...
            <div class="sponsorshipform">
                ...
                <form id="approveform" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input id="ins_type_id" type="hidden" name="childname" class="form-control"
                               placeholder="order_id" disabled>
                    </div>
                    ...
                    <div class="approveorderform">
                        ...
                        <div class="form-group">
                            <input type="submit" value="Approve" style="width: 100% !important;"
                                   class="sponsorchildnowbtn">
                        </div>
                        <div class="form-group">
                            <button type="reset" id="cancelbtn"
                                    style="background: #fff;border: 1px solid #000;padding: 10px 20px;width: 100%;color: #000; border-radius: 5px;"
                                    onclick="cancelsponsohip()">Cancel
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="deleteorder" style="display: none;">
                        ...
                        <div id="error"></div>
                        <div class="form-group">
                            <input type="submit" value="Delete" style="width: 100% !important;"
                                   class="sponsorchildnowbtn">
                        </div>
                        <div class="form-group">
                            <button type="reset" id="cancelbtn"
